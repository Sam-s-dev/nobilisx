...
"""
Service d'envoi d'emails aux entreprises (resumes d'appels d'offres).

L'envoi lui-meme est delegue a app/services/email_sender.py, qui essaie
successivement Brevo, SMTP2GO, Resend, Mailjet puis le SMTP classique — le
tout en HTTPS, seule methode qui fonctionne sur un hebergeur cloud ou les
ports SMTP sont bloques.
"""
...
class EmailService:
    """Service d'envoi d'emails aux entreprises"""
...
<table width="620" cellpadding="0" cellspacing="0" style="max-width:620px;width:100%;">
  ...
  <tr><td style="background:#f8f9fc;padding:28px 22px;border-radius:0 0 20px 20px;border:1px solid #eaedf2;border-top:none;">
    ...
    def _send_email_intelligent(self, to_email: str, subject: str, html_body: str, pdf_path: str | None = None) -> bool:
        ...
        Lève EmailProviderError si aucun fournisseur n'a abouti (le détail de la
        réponse de l'API est conservé dans le message, pour les logs Render).
        """
